...
public class MainActivity extends AppCompatActivity {
    ...
    //This is the intent filter declared in app 3's manifest file
    private final static String START_3_ACTION = "edu.uic.cs478.s19.start3";
    ...
    public void checkPermAndStartReceiver() {
        ...
        if (checkSelfPermission(KABOOM_PERMISSION) == PackageManager.PERMISSION_GRANTED) {
            if (receiver == null) {
                ...
                receiverStatusText.setText("Receiver for application 2 is started.");

                // Show toast
                Toast.makeText(this, "Receiver for application 2 is started.", Toast.LENGTH_SHORT).show();
            }

            // Start app 3
            Intent intent = new Intent();
            intent.setAction(START_3_ACTION);
